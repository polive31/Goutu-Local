...
class Custom_Batch_Manage_Posts
{
	...
	public function __construct()
	{
		...
		$Tax_Meta = new CBMP_Post_Content();
		add_action("wp_ajax_ManageContent", 			array($Tax_Meta, "ajax_batch_manage_content"));
		add_shortcode('batch-manage-post-content', 		array($Tax_Meta, 'batch_manage_post_content_shortcode'));
