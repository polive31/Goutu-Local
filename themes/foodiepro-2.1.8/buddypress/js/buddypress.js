...
jq(document).ready( function() {
	...
	//console.log('Child Theme Javascript loaded !!!!');
	/**** Page Load Actions *******************************************************/
	...
	/* New posts */
	jq('#whats-new-textarea' ).keypress(function (e) {
	...
	jq('#aw-whats-new-submit' ).on( 'click', function submitPost() {
		...
		jq.post( ajaxurl, post_data, function( response ) {
			...
			jq( '#whats-new-submit' ).removeClass( 'loading' );
			jq( '#whats-new-content' ).removeClass( 'active' );
