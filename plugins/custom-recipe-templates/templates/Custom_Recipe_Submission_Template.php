...
?>
		    ...
		    <?php
		            ...
		            else
		            {
		                ...
		                $has_image = false;
								...
								$this->output_instruction($instructions,$i,false);
		            $i++;
		        }
    ...
    <tr class="instruction">
        <td class="sort-handle"><img src="<?php echo WPUltimateRecipe::get()->coreUrl; ?>/img/arrows.png" width="18" height="16"></td>
        <td>
            <textarea name="recipe_instructions[<?php echo $index; ?>][description]" rows="4" id="ingredient_description_<?php echo $index; ?>"><?php echo $instruction['description']; ?></textarea>
