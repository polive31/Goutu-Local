	...
	********************************************************************************/
	...
	public function setup_CPM_recipe_labels( $labels ) {
		$labels['recipe'] = array(
			...
			'back'						=> _x( 'Back to <a href="%s" onclick="formSubmitting=true;">my posts</a>.', 'recipe', 'foodiepro'),
			'publish-admin'				=> _x( 'Dear administrator, this post is now <a href="%s" onclick="formSubmitting=true;">published</a>.', 'recipe', 'foodiepro' ),
