...
function foodie_pro_enqueue_syles() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Amatic+SC:400|PT+Sans+Narrow|Roboto+Slab|Lato:300|Delius+Swash+Caps', array(), CHILD_THEME_VERSION );
}
