...
<head>
	...
	<title>Message de l'arrière cuisine...</title>
	<title>Goûtu.org est actuellement en maintenance</title>
	...
	<meta property="og:title" content="Goutu Maintenance Mode" />
...
<body>
	<div id="cspio-page">
		<div id="cspio-content">
			...
			<div id="cspio-description">We are currently performing some quick updates. Leave us your email and we'll let you know as soon as we are back up again.</div>			    				
			...
			<div id="cspio-credit">
					<span>Created with <a target="_blank" href="https://www.seedprod.com"><img id="aff" src="https://static.comingsoonpage.com/cspio-assets/1.0.0/seedprod-logo-white.png" alt="Created by SeedProd.com"></a> Free download <a target="_blank" href="https://www.seedprod.com/how-to-create-custom-maintenance-mode-page-wordpress/" style="text-decoration:underline" alt="Get your free WordPress error page.">here.</a>
				</span></div>
