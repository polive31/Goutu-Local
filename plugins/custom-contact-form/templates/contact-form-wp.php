		...
		<form action="<?php echo esc_url(admin_url('admin-post.php'));  ?>" id="contactForm" method="post">
			...
			<div class="fieldset buttons">
				<input type="hidden" name="action" value="ccf_submit">
				<input type="submit" value="<?= __('Send Message', 'foodiepro'); ?>">
			</div>
