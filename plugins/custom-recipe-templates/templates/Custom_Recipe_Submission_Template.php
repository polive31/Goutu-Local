...
private function output_recipe_form( $recipe, $required_fields ) {
	...
	<div class="recipe-ingredients-container">
	    ...
	    <table id="recipe-ingredients">
	            ...
	            foreach( $ingredients as $ingredient ) {
	                ...
	                <tr class="ingredient">
	                    ...
	                    <td>
	                        ...
	                        <textarea rows="1" name="recipe_ingredients[<?php echo $i; ?>][notes]"      class="ingredients_notes" id="ingredient_notes_<?php echo $i; ?>" value="<?php echo esc_attr( $ingredient['notes'] ); ?>" ></textarea>
	        ...
	        <tr class="ingredient">
	            ...
	            <td>
	                <textarea rows="1" name="recipe_ingredients[<?php echo $i; ?>][notes]"      class="ingredients_notes" id="ingredient_notes_<?php echo $i; ?>" <?php if($i == 0) { echo 'value="' . __( 'extra virgin', 'wp-ultimate-recipe' ) . '"'; } ?> ></textarea>
	...
	public function output_recipe_item($class, $args) {?>
      ...
      <tr class="recipe-general-form-<?php echo $class?>">
        <td class="recipe-general-form-label"><label for="recipe_<?php echo $class?>"><?php echo $args['title'] ?><?php if( $args['required'] ) echo '<span class="wpurp-required">*</span>'; ?></label></td>
	...
	private function class_hydrate($recipe, $required_fields) {
    	...
    	'servings' => array(
	    	'title' => __( 'Servings', 'wp-ultimate-recipe' ),
	    	'notes' => __( '(e.g. 2 people, 3 loafs, ...)', 'wp-ultimate-recipe' ),
			...
			'prep-time' => array(
	    	'title' => __( 'Prep Time', 'wp-ultimate-recipe' ),
	    	'notes' => __( '(e.g. 20 minutes, 1-2 hours, ...)', 'wp-ultimate-recipe' ),
    	...
    	'cook-time' => array(
	    	'title' => __( 'Cook Time', 'wp-ultimate-recipe' ),
	    	'notes' => __( '(e.g. 20 minutes, 1-2 hours, ...)', 'wp-ultimate-recipe' ),
	    	'required' => false,
	   		'inputs' => array( 
		    	'prep_time' => array( 'value', $recipe->prep_time() ),
    	...
    	'passive-time' => array(
	    	'title' => __( 'Passive Time', 'wp-ultimate-recipe' ),
	    	'notes' => __( '(e.g. 20 minutes, 1-2 hours, ...)', 'wp-ultimate-recipe' ),
	    	'required' => false,
	   		'inputs' => array( 
