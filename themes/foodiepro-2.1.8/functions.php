...
function foodie_pro_enqueue_syles() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Amatic+SC:400|Droid+Sans|Source+Sans+Pro|Lato:300|Delius+Swash+Caps', array(), CHILD_THEME_VERSION );
}
