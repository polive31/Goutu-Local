...
function foodie_pro_enqueue_fonts() {
	...
	wp_enqueue_style( 'google-fonts', '//fonts.googleapis.com/css?family=Amatic+SC:400,700|Podkova|Oswald|Lato:300,400', array(), CHILD_THEME_VERSION );
...
function dequeue_header_styles() {
  ...
  wp_dequeue_style('galleria-fs');
  wp_deregister_style('wpurp_style5');  
  wp_dequeue_style('wpurp_style5');
  wp_deregister_style('wpurp_style6');  
  wp_dequeue_style('wpurp_style6');    
