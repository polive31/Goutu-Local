	...
	<div class="ps-page ps-page--profile ps-page--profile-about">
		...
		<div class="ps-profile ps-profile--edit ps-profile--about">
			...
			<div class="ps-profile__edit">
				...
				<?php if( $can_edit ) { ?>
				<div class="ps-profile__progress ps-completeness-info ps-js-profile-completeness" <?php if( $stats['completeness'] >= 100 && $stats['missing_required'] <= 0) { ?>style="display:none"<?php } ?>>
					<div class="ps-profile__progress-message ps-completeness-status ps-js-status
						...
						<?php } ?>" <?php if( $stats['completeness'] >= 100 && $stats['missing_required'] <= 0) { ?>
							style="display:none"
						<?php } ?>>
						...
						<div class="ps-profile__about-fields ps-js-profile-list">
							<?php if( count($fields) ) { ?>
								<?php foreach ($fields as $key => $field) { ?>
									<?php $field_can_edit = ($can_edit && !isset($field::$user_disable_edit)); ?>
