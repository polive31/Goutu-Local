	...
	<div class="page" id="register-page">
		...
		<?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
			...
			<?php if ( bp_registration_needs_activation() ) : ?>
				<h3><?php _e( 'Registration completed', 'foodiepro' ); ?></h3>
				<p><?php _e( 'You have successfully completed the registration!<br>In order to create your account, please activate it via the email we have just sent to your address.', 'foodiepro' ); ?></p>
			<?php else : ?>
