	...
	<!-- Class .wpurp-container important for adjustable servings javascript -->	
        ...
        $tooltip_text = __('Print', 'foodiepro');
				...
				<?php
					...
					<div class="button-tooltip"><?php echo __('Add to Shopping List','foodiepro'); ?></div>
				</div>				
				...
				<?php
					...
					<div class="button-tooltip"><?php echo __('Add to Favorites','foodiepro'); ?></div>
				</div>				
...
function custom_favorite_button( $recipe )
    {
        ...
        ob_start();
				?>
				<a href="#" class="recipe-function wpurp-recipe-favorite" data-recipe-id="<?php echo $recipe->ID(); ?>"><?php echo $icon; ?>
...
class WPURP_Custom_Recipe_Add_To_Shopping_List extends WPURP_Template_Block {
    ...
    public $icon = 'fa-cart-arrow-down';
    public $icon_alt = 'fa-shopping-cart';
