...
----------------------------------------------------------------*/
	...
	public function output_toggle_switch_recording_cb() {
		$this->output->toggle_switch( 'general_record', $this->record );
	}	

	public function output_toggle_switch_optimize_cb() {
		$this->output->toggle_switch( 'general_optimize', $this->optimize );
	}		
	
	public function output_toggle_switch_javasync_cb() {
		$this->output->toggle_switch( 'general_javasync', $this->javasync );
	}	
